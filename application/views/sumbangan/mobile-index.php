...
<div class="m-content">
  <p class="m-page-title">Sumbangan</p>
  ...
  <?php if (!$baca_saja) : ?>
    <div class="m-popup-overlay" id="formTambahDana" hidden>
      <div class="m-popup-sheet">
        <?= form_open('sumbangan/add', ['class' => 'm-popup-form']); ?>
        <div class="m-popup-header">
          <p class="m-popup-title">Tambah Sumbangan</p>
        ...
        <div class="m-popup-body">
          ...
          <div class="m-field">
            <label>Perihal</label>
            <input type="text" name="perihal" placeholder="Masukkan perihal sumbangan" required autocomplete="off">
          </div>
          <div class="m-field">
  ...
  <div id="mDanaList">
        ...
        <?php if (!$baca_saja) : ?>
          <div class="m-dana-swipe-wrap">
            <div class="m-dana-swipe-actions-kiri">
              <button type="button" data-toggle-target="#editDana<?= $dn['IdSumbangan']; ?>">
                <i class="fas fa-pen"></i> Ubah
              </button>
            </div>
            <div class="m-dana-swipe-actions-kanan">
              <a href="<?= base_url('sumbangan/delete/' . $dn['IdSumbangan']); ?>" class="tombol-hapus" tipeData="Sumbangan" namaData="<?= html_escape($dn['Perihal']); ?>">
          ...
          <div class="m-popup-overlay" id="editDana<?= $dn['IdSumbangan']; ?>" hidden>
            <div class="m-popup-sheet">
              <?= form_open('sumbangan/update/' . $dn['IdSumbangan'], ['class' => 'm-popup-form']); ?>
              <div class="m-popup-header">
                <p class="m-popup-title">Ubah Sumbangan</p>
                <button type="button" class="m-popup-close" data-toggle-target="#editDana<?= $dn['IdSumbangan']; ?>"><i class="fas fa-times"></i></button>
              </div>
              <div class="m-popup-body">
                <div class="m-field">
                  <label>Tanggal</label>
    ...
    <?php else : ?>
      <div class="m-card">
        <p class="m-empty">Belum ada data sumbangan.</p>
      </div>
    <?php endif; ?>
  </div>
</div>
...
<?php if (!$baca_saja) : ?>
  <button type="button" class="m-fab" data-toggle-target="#formTambahDana" aria-label="Tambah Sumbangan">
    <i class="fas fa-plus"></i>
  </button>
<?php endif; ?>

<script>
  // Toggle generik [data-toggle-target] & input nominal ribuan sudah ditangani global oleh
  // assets/js/mobile.js (lihat komentar sama di dana/mobile-index.php) - tidak perlu disalin lagi.
