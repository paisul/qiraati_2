      ...
      <div class="row">
        ...
        <div class="col-sm">
          <div class="card">
            ...
            <!-- Swall -->
            <div class="flash-data" data-flashdata="<?= isset($pesan) ? $pesan : $this->session->flashdata('pesan'); ?>" data-title="Data Setoran">
            </div>
            <div class="card-body">
              <!-- Add/Import/Export -->
              <div class="col mb-3">
                  ...
                  foreach ($setoran as $setor) : ?>
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="<?= base_url('Halaman_Musyrif/delete_setoran/' . $setor['IdSetoran']); ?>" class="btn btn-danger ml-3 tombol-hapus" tipeData="Setoran" namaData=<?= $setor['NamaKelompok']; ?>>Hapus</a>
                      </td>
                    </tr>
                  <?php endforeach; ?>
                </tbody>
  ...
  <div class="modal fade" id="editSetoran<?= $str['IdSetoran'] ?>">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <?= form_open('Halaman_Musyrif/update_setoran/' . $str['IdSetoran']); ?>
          <!-- Isi Target -->
          <div class="form-group row">
            <div class="col-sm-4">
              <label for="isi">Isi Target</label>
