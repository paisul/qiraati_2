    ...
    <div class="card" style="width: 25rem;">
      <div class="card-body login-card-body" style="background-color: #74b3ce; color: white;">
        <div class="row">
          ...
          <div class="col-sm-8">
            <h4 style="text-align: center;">Form Changes Password</h4>
            ...
            <form action="<?= base_url('auth/reset_password'); ?>" method="POST">
              <div class="row">
                ...
                <div class="input-group mb-3 col-auto">
                  <input type="text" class="form-control" placeholder="Username" name="username" value="<?= $datausername; ?>" readonly autocomplete="off">
                </div>
                <?= form_error('username', '<small class="text-danger ml-2">', '</small>'); ?>
                <div class="input-group mb-3 col-auto">
                  <input type="password" class="form-control" placeholder="Password Baru" name="password1" autofocus required>
                </div>
