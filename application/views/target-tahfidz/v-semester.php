      ...
      <div class="row">
        ...
        <div class="col-sm">
          <div class="card">
            ...
            <!-- Swall -->
            <div class="flash-data" data-flashdata="<?= isset($pesan) ? $pesan : $this->session->flashdata('pesan'); ?>" data-title="Data Semester">
            </div>
            <div class="card-body">
              <!-- Add/Import/Export -->
              <div class="col mb-3">
                ...
                <a href="<?= base_url('tahfidz/semester/export_excel'); ?>" target="_blank" class="btn btn-primary"><i class="fas fa-file-excel"></i> Export Data</a>
              </div>
