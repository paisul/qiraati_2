      ...
      <div class="row">
        ...
        <div class="col-sm">
          <div class="card">
            ...
            <!-- Swall -->
            <div class="flash-data" data-flashdata="<?= isset($pesan) ? $pesan : $this->session->flashdata('pesan'); ?>" data-title="Data Detail Target">
            </div>
            <div class="card-body">
              <!-- Add/Import/Export -->
              <div class="col mb-3">
                ...
                <a href="<?= base_url('tahfidz/detail_target/export_excel'); ?>" target="_blank" class="btn btn-primary"><i class="fas fa-file-excel"></i> Export Data</a>
              </div>
                ...
                <tbody>
                  ...
                  foreach ($detail as $det) : ?>
                    <tr>
                      ...
                      <td><?= $det['JenisTarget'] == 'Doa/Qosidah' ? 'Doa/Qosidah' : "Qur'an"; ?></td>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-8">
            <select name="jenis_target" class="form-control" required>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-8">
              <select name="jenis_target" class="form-control" required>
                <option value="Quran" <?= $dt['JenisTarget'] != 'Doa/Qosidah' ? 'selected' : ''; ?>>Qur'an</option>
                <option value="Doa/Qosidah" <?= $dt['JenisTarget'] == 'Doa/Qosidah' ? 'selected' : ''; ?>>Doa/Qosidah</option>
              </select>
            </div>
          </div>
          <div class="form-group row">
