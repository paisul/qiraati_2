      ...
      <div class="row">
        ...
        <div class="col-sm">
          <div class="card">
            ...
            <div class="flash-data" data-flashdata="<?= isset($pesan) ? $pesan : $this->session->flashdata('pesan'); ?>" data-title="Raport">
            </div>
            <div class="card-body">
              ...
              <form action="<?= base_url('Raport/aksi_tampil'); ?>" method="POST">
                ...
                <div class="form-group">
                  ...
                  <select name="periode_ujian" id="periode_ujian" class="form-control" required>
