      ...
      <div class="row">
        ...
        <div class="col-sm">
          <div class="card">
            ...
            <!-- Swall -->
            <div class="flash-data" data-flashdata="<?= isset($pesan) ? $pesan : $this->session->flashdata('pesan'); ?>" data-title="Data Pengguna">
            </div>
            <div class="card-body">
              <!-- Add/Import/Export -->
              <div class="col mb-3">
                    ...
                    <tr>
                      ...
                      <td>
                        <?php if (!empty($akun['IdSiswa'])) : ?>
                          <a href="<?= base_url('santri/detail/' . $akun['IdSiswa']); ?>"><?= $akun['username']; ?></a>
                        <?php elseif (!empty($akun['IdMusyrif'])) : ?>
                          <a href="<?= base_url('musyrif#editMusyrif' . $akun['IdMusyrif']); ?>"><?= $akun['username']; ?></a>
                        <?php else : ?>
                          <?= $akun['username']; ?>
                        <?php endif; ?>
                      </td>
                      ...
                      <td>
                        ...
                        <?php if (strcasecmp($akun['username'], 'turanisia.tv@gmail.com') === 0) : ?>
                          <span class="badge badge-secondary ml-3"><i class="fas fa-lock"></i> Admin Utama</span>
                        <?php else : ?>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
          ...
          <small class="form-text text-muted">Akun Wali/Musyrif/Santri dibuat lewat halaman masing-masing (Data Musyrif, pendaftaran Wali/Santri), bukan di sini.</small>
        </div>
        <div class="form-group">
