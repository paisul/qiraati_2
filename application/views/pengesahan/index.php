      ...
      <div class="row">
        ...
        <div class="col-sm">
          <div class="card">
            ...
            <!-- Swall -->
            <div class="flash-data" data-flashdata="<?= isset($pesan) ? $pesan : $this->session->flashdata('pesan'); ?>" data-title="Data Pengesahan">
            </div>
            <div class="card-body">
              <!-- Add/Import/Export -->
              <div class="col mb-3">
                ...
                <tbody>
                  ...
                  foreach ($pengesahan as $p) : ?>
                    <tr>
                      ...
                      <td>
                        <?php if (!empty($p['Ttd'])) : ?>
                          <img src="<?= upload_url('ttd', $p['Ttd']); ?>" width="100px" height="100px">
                        <?php else : ?>
