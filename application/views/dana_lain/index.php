    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="perihal" name="perihal" placeholder="Masukkan perihal" required autocomplete="off">
        </div>
        <div class="form-group">
...
<?php foreach ($dana as $dn) : ?>
  <div class="modal fade" id="editDana<?= $dn['IdDanaLain']; ?>">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header bg-success">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <label for="perihal<?= $dn['IdDanaLain']; ?>">Perihal</label>
            <input type="text" class="form-control" id="perihal<?= $dn['IdDanaLain']; ?>" name="perihal" value="<?= html_escape($dn['Perihal']); ?>" required autocomplete="off">
          </div>
          <div class="form-group">
            <label for="jumlah_masuk<?= $dn['IdDanaLain']; ?>">Jumlah Masuk</label>
            <input type="number" class="form-control" id="jumlah_masuk<?= $dn['IdDanaLain']; ?>" name="jumlah_masuk" value="<?= $dn['JumlahMasuk']; ?>" min="0" step="1" oninput="this.value = Math.max(0, this.value || 0)" required>
            <small class="text-muted">Minimal 0</small>
          </div>
          <div class="form-group">
            <label for="jumlah_keluar<?= $dn['IdDanaLain']; ?>">Jumlah Keluar</label>
            <input type="number" class="form-control" id="jumlah_keluar<?= $dn['IdDanaLain']; ?>" name="jumlah_keluar" value="<?= $dn['JumlahKeluar']; ?>" min="0" step="1" oninput="this.value = Math.max(0, this.value || 0)" required>
            <small class="text-muted">Minimal 0</small>
          </div>
        </div>
        <div class="modal-footer justify-content-between">
