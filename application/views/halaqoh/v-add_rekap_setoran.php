      ...
      <div class="row">
        ...
        <div class="col-sm">
          <div class="card">
            ...
            <!-- Swall -->
            <div class="flash-data" data-flashdata="<?= isset($pesan) ? $pesan : $this->session->flashdata('pesan'); ?>" data-title="Data Rekap Setoran">
            </div>
            <div class="card-body">

              <form action="<?= base_url('halaqoh/rekap_setoran/form_add'); ?>">
                <!-- Isi Target -->
              ...
              <table class="table table-bordered table-striped text-center">
                ...
                <tbody>
                  <form action="<?= base_url('halaqoh/rekap_setoran/add_hasil'); ?>" method="POST">
