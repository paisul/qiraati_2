...
class Detail_kelompok extends CI_Controller
{
    ...
    if ($this->form_validation->run() == FALSE) {
      ...
      if ($idKelas || $idKelompok) {
        $data = [
          ...
          'pesan'           => $pesan,
          'isi'             => tampilan_mobile() ? 'halaqoh/mobile-detail_kelompok' : 'halaqoh/v-detail_kelompok',
        ];
  ...
  public function add()
  {
    ...
    redirect('halaqoh/detail_kelompok?pesan=' . rawurlencode('Berhasil ditambahkan!'));
  }
  ...
  public function update($id)
  {
    ...
    redirect('halaqoh/detail_kelompok?pesan=' . rawurlencode('Berhasil diubah!'));
  }
  ...
  public function delete($id)
  {
    ...
    redirect('halaqoh/detail_kelompok?pesan=' . rawurlencode('Berhasil dihapus!'));
  }

  public function reset_data()
  {
    $this->Detail_kelompok_M->kosongkanDetailKelompok();
    redirect('halaqoh/detail_kelompok?pesan=' . rawurlencode('Berhasil direset!'));
  }
