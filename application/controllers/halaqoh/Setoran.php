...
class Setoran extends CI_Controller
{
  ...
  public function index($offset = 0)
  {
    ...
    $data = [
      ...
      'pesan' => $pesan,
      'isi'     => tampilan_mobile() ? 'halaqoh/mobile-setoran' : 'halaqoh/v-setoran',
    ];
  ...
  public function add()
  {
    // "kelompok" (nama Kelompok, sekadar penyaring untuk AJAX getSantriByKelompok) dan
    // "detail_kelompok" (santri yang benar-benar dipilih di dalam kelompok itu) dulu SAMA-SAMA
    // pakai name="kelompok" di form - dua field beda tertimpa satu sama lain begitu form
    // dikirim/dibaca ulang lewat JS, bikin pilihan Santri kelihatan "diminta pilih lagi".
    $data = [
      'IdDetailTarget' => $this->input->post('isi'),
      'IdJadwal' => $this->input->post('jadwalHalaqoh'),
      'IdDetailKelompok' => $this->input->post('detail_kelompok'),
      'Presensi' => $this->input->post('presensi'),
      'Keterangan' => $this->input->post('keterangan')
    ];
    $this->Setoran_M->addSetoran($data);
    redirect('halaqoh/setoran?pesan=' . rawurlencode('Berhasil ditambahkan!'));
  }
  ...
  public function update($id)
  {
    ...
    redirect('halaqoh/setoran?pesan=' . rawurlencode('Berhasil diubah!'));
  }
  ...
  public function delete($id)
  {
    ...
    redirect('halaqoh/setoran?pesan=' . rawurlencode('Berhasil dihapus!'));
  }
  ...
  public function reset_data()
  {
    ...
    redirect('halaqoh/setoran?pesan=' . rawurlencode('Berhasil direset!'));
  }
