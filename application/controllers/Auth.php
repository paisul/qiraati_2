...
class Auth extends CI_Controller
{
  ...
  public function index()
  {
    ...
    $this->load->view(tampilan_mobile() ? 'auth/mobile-login' : 'auth/login', $data);
  }
  ...
  {
    // sess_destroy() (bukan cuma unset username/level) - supaya SEMUA data session lama benar-benar
    // hilang, termasuk flashdata yang mungkin nyangkut/tidak kadaluarsa dengan benar. Login
    // berikutnya mulai dari session yang benar-benar bersih.
